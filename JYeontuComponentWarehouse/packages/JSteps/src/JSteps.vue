<template>
	<div class="j-steps" id="j-steps">
        <div v-for="(item,index) in showDataList" :key="index" class="j-steps-item">
            <div class="item-header">
                <div class="left-box">
                    <template v-if="index % 2 == 0">
                        <div class="top-box" :style="obj2Style(titleStyle)">{{item.title}}</div>
                        <div class="bottom-box" :style="obj2Style(descriptStyle)">{{item.descript}}</div>
                    </template>
                    <template v-else>
                        <div class="hold-box" :style="obj2Style(timeStyle,'text-align: right;padding-right: 5px;')">{{item.time}}</div>
                    </template>
                </div>
                ...
                <div class="right-box" >
                    ...
                    <template v-else>
                        <div class="hold-box" :style="obj2Style(timeStyle,'text-align: left;padding-left: 5px;')">{{item.time}}</div>
                    </template>
                </div>
            </div>
