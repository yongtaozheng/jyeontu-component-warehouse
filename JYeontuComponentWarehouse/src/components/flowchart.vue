	...
	<div class="flow-chart">
		...
		<div id="moveDiv"
		  ...
		  <img :src="selectedItem.icon"
		   ...
		   <div :style="getIconStyle('text')"
				v-if="selectedItem.icon == ''"
			   :class="getClass('chart-content-item-icon','radius')"
			>{{selectedItem.text[0]}}</div>
		...
		<div class="chart-content"
			ref="chartContent"
			id="chartContent">
			<div class="chart-content-column"
				...
				<div class="chart-content-item"
					...
					<div class="chart-content-line"
						v-if="index == 0 && index1 % 2 == 1 && index1 < chartDataList.length - 1"
